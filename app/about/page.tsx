  ...
  return (
    <>
      <Section title='About Us' > 
        <p>Welcome to Green Growth Cycle, Phnom Penh’s top resource for recycling! We aim to create a greener future by connecting residents and businesses with trusted recycling services and manufacturers. Discover how easy it is to recycle responsibly and support a cleaner city with us!</p>
      </Section>
      <MissionSection/>
